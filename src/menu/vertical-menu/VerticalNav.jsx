...
import StyledBackdrop from '@/components/layouts/styles/StyledBackdrop'
import StyledVerticalNav from '@/components/layouts/styles/vertical/StyledVerticalNav'
import StyledVerticalNavContainer from '@/components/layouts/styles/vertical/StyledVerticalNavContainer'
import StyledVerticalNavBgColorContainer from '@/components/layouts/styles/vertical/StyledVerticalNavBgColorContainer'

// Style Imports
import styles from '@/components/layouts/styles/vertical/verticalNavBgImage.module.css'

// Default Config Imports
import { defaultBreakpoints, verticalNavToggleDuration } from '@/menu/defaultConfigs'
